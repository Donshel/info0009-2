...
CREATE TABLE IF NOT EXISTS articles(
	...
	doi BIGINT NOT NULL UNIQUE,
	titre VARCHAR(255) NOT NULL,
	date_publication DATE NOT NULL,
	matricule_auteur INT NOT NULL,
	PRIMARY KEY (url),
	FOREIGN KEY (matricule_auteur) REFERENCES auteurs (matricule)
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS articles_journaux(
	...
	n_journal SMALLINT NOT NULL,
	CHECK (pg_debut <= pg_fin),
	PRIMARY KEY (url),
	FOREIGN KEY (url) REFERENCES articles (url),
